...
GUI_LIST_ITEM			arrstTestListItems[]	= {	{"列表项0 - 超长列表项",	LIST_ITEM_NORMAL,	{0}, 			{0, 0, 0}, NULL},
													...
													{"列表项6 - 数字",		LIST_ITEM_DIGIT,	{1234567890},	{0, 0, 0}, NULL},
													{"列表项7 - 小数",		LIST_ITEM_DIGIT,	{12345}, 		{2, 0, 2}, NULL},
													{"列表项8 - 小数",		LIST_ITEM_DIGIT,	{66},			{4, 0, 3}, NULL},
													{"列表项9 - 数字",		LIST_ITEM_DIGIT,	{-100},			{0, 0, 0}, NULL},
													{"列表项A - 小数",		LIST_ITEM_DIGIT,	{-123},			{1, 0, 1}, NULL},
